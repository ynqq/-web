...
x0popup = x0p = function () {
    ...
    x.overlay && (y += '<div id="x0p-overlay" class="x0p-overlay' + (x.animation && x.overlayAnimation ? "" : " no-animation") + '"></div>'), y += '<div id="x0popup" class="x0p ' + x.theme + (0 == x.animation ? " no-animation" : "") + (0 == c.length ? " no-button" : "") + '" style="' + t() + '">', y += '<div class="contentx0pop">', y += h ? '<div class="text-pure-wrapper">' : n() + '<div class="text-wrapper">', y += '<div id="x0p-text-anchor" class="text-anchor">', y += '<div class="title">' + x.title + "</div>", null != x.text && (y += '<div class="text">' + (x.html ? x.text : p(x.text)) + "</div>"), null != g && (y += '<div class="input">' + s() + '<input id="x0p-input" type="' + g + '" placeholder="' + w + '" value="' + b + '"></div>'), y += "</div>", y += "</div>", y += "</div>", y += C, y += "</div>", l();
